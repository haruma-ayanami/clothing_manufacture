...
public class CustomerOrdersViewModel : BaseViewModel
{
    ...
    public Employee? SelectedManagerEmployee
    {
        get => _selectedManagerEmployee;
        set { _selectedManagerEmployee = value; OnPropertyChanged(); RefreshCommands(); }
    }
    ...
    public string FormOrderNumber
    {
        ...
        set { _formOrderNumber = value; OnPropertyChanged(); RefreshCommands(); }
    }
    ...
    {
        get => _formOrderDate;
        set { _formOrderDate = value; OnPropertyChanged(); RefreshCommands(); }
    }
    ...
    {
        get => _formDueDate;
        set { _formDueDate = value; OnPropertyChanged(); RefreshCommands(); }
    }
    ...
    public string? FormBrandingRequirements
    {
        get => _formBrandingRequirements;
        set { _formBrandingRequirements = value; OnPropertyChanged(); RefreshCommands(); }
    }
