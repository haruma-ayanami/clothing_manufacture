...
public class ClassifiersViewModel : BaseViewModel
{
    private ObservableCollection<Classifier> _classifiers = new();
    private ObservableCollection<Classifier> _parentClassifiers = new();
    private Classifier? _selectedClassifier;
    private Classifier? _selectedParentClassifier;
    private string _formClassifierType = string.Empty;
    private string _formValue = string.Empty;
    private string? _formCode = null;
    private string? _formSortOrder = null;
    private string? _formDescription = null;
    private string _statusMessage = "Готово к работе.";
    private bool _isBusy;

    public ClassifiersViewModel()
    {
    ...
    public ObservableCollection<Classifier> Classifiers
    {
        get => _classifiers;
        set { _classifiers = value; OnPropertyChanged(); }
    }


    public ObservableCollection<Classifier> ParentClassifiers
    {
        get => _parentClassifiers;
        set { _parentClassifiers = value; OnPropertyChanged(); }
    }
    ...
    public Classifier? SelectedClassifier
    {
        ...
        set { _selectedClassifier = value; OnPropertyChanged(); RefreshCommands(); }
    }


    public Classifier? SelectedParentClassifier
    {
        get => _selectedParentClassifier;
        set { _selectedParentClassifier = value; OnPropertyChanged(); RefreshCommands(); }
    }


    public string FormClassifierType
    {
        get => _formClassifierType;
        set { _formClassifierType = value; OnPropertyChanged(); RefreshCommands(); }
    }
    ...
    {
        get => _formValue;
        set { _formValue = value; OnPropertyChanged(); RefreshCommands(); }
    }
    ...
    {
        get => _formCode;
        set { _formCode = value; OnPropertyChanged(); RefreshCommands(); }
    }


    public string? FormSortOrder
    {
        get => _formSortOrder;
        set { _formSortOrder = value; OnPropertyChanged(); RefreshCommands(); }
    }
